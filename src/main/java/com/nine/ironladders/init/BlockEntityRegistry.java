...
public class BlockEntityRegistry {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<MetalLadderEntity>> METAL_LADDER = BLOCK_ENTITIES.register(
            "metal_ladder_entity",
            () -> new BlockEntityType<>(MetalLadderEntity::new,
