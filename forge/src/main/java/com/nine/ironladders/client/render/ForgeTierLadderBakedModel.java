...
public class ForgeTierLadderBakedModel extends BakedModelWrapper<BakedModel> {
	
	public static final ModelProperty<LadderRenderData> MODEL_DATA = new ModelProperty<>();
	
	public ForgeTierLadderBakedModel(BakedModel bakedModel) {
		super(bakedModel);
	}
	...
	public TextureAtlasSprite getParticleIcon(ModelData data) {
		...
		} else if (delegate instanceof ForgeTierLadderBakedModel wrapper) {
	...
	public List<BakedQuad> getQuads(
		...
		// Avoid passing our model data into another ladder wrapper to prevent recursion.
		ModelData childData = (renderState.getBlock() instanceof MetalLadderBlock) ? ModelData.EMPTY : safeData;
