...
public record ILBlockModelGenerator(Consumer<BlockStateGenerator> originalStateOutput,
                                    BiConsumer<ResourceLocation, Supplier<JsonElement>> stateOutput,
    ...
    private static final ResourceLocation SENSOR_OFF = ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/sensor/sensor_off");
    private static final ResourceLocation SENSOR_ON = ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/sensor/sensor_on");

    private static final ResourceLocation LIGHT_TEXTURE = ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/light/light");
    ...
    private void generateBaseModel(
        ...
        var baseTemplate = new ModelTemplate(
                Optional.of(ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/template/template_ladder" + templateSuffix)),
                Optional.empty(),
                LADDER_TEXTURE_SLOT,
        ...
        TextureMapping textureMapping = new TextureMapping()
                .put(LADDER_TEXTURE_SLOT, ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, basePath + "_block" + textureSuffix))
                .put(TextureSlot.PARTICLE, ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, basePath));
    ...
    private void generateSensorModels(
        ...
        var sensorTemplate = new ModelTemplate(
                Optional.of(ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/template/template_ladder" + templateSuffix + "_sensor")),
                Optional.empty(),
                LADDER_TEXTURE_SLOT,
                SENSOR_SIGNAL_TEXTURE_SLOT
        );

        ResourceLocation ladderTexture = ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, basePath + "_block" + textureSuffix);
        ...
        modelLocation = ResourceLocation.fromNamespaceAndPath(
    ...
    private void generateLightModel(
        ...
        var lightTemplate = new ModelTemplate(
                Optional.of(ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/template/template_ladder" + templateSuffix + "_light")),
                Optional.empty(),
                LADDER_TEXTURE_SLOT,
                LIGHT_TEXTURE_SLOT
        );
    ...
    private void generateBlockStateMultipart(
        ...
        for (var facing : Direction.Plane.HORIZONTAL) {
            generator.with(
                    ...
                    variantFor(ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/" + modelBlockId), facing)
            );
        }

        // Light module
        ResourceLocation lightModel = ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/" + modelBlockId + "_light");
        for (var facing : Direction.Plane.HORIZONTAL) {
            generator.with(
                    Condition.condition()
    ...
    private void generateMultiVariantBlockStateMultipart(
        ...
        for (int i = 0; i < variantLadderBlock.variants; i++) {
            ...
            ResourceLocation baseModel = ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/" + variantId);
            for (var facing : Direction.Plane.HORIZONTAL) {
                generator.with(
                        Condition.condition()
                                .term(BlockStateProperties.HORIZONTAL_FACING, facing)
        ...
        // Light module
        for (int i = 0; i < variantLadderBlock.variants; i++) {
            ResourceLocation lightModel = ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/" + modelBlockId + "_variant_" + i + "_light");
            for (var facing : Direction.Plane.HORIZONTAL) {
                generator.with(
                        Condition.condition()
                                .term(BlockStateProperties.HORIZONTAL_FACING, facing)
    ...
    private void acceptState(BlockStateGenerator generator, boolean useOriginalOutput, String blockId) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, blockId);
    ...
    private static ResourceLocation sensorModelId(String baseModelId, boolean active) {
        ...
        return ResourceLocation.fromNamespaceAndPath(ILCommon.MODID, "block/" + baseModelId + suffix);
    }
